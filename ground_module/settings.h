...
#define TOTAL_NODE  2  // Total number of all nodes excluding central module
...
constexpr uint8_t SENSOR_COUNT = floor( (dht_sensor_count + moist_sensor_count) / 2 );
  ...
  #define SENSOR_THRES  2  // How many nodes must be below threshold for the drone to start watering
